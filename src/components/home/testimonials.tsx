    ...
    <section className="relative overflow-hidden bg-ink">
      ...
      <div className="container-page section-y relative">
        <div className="mb-14 text-center">
          ...
          <div className="mx-auto mt-5 h-px w-16 bg-gradient-to-r from-gold-light to-transparent" />
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {reviews.slice(0, 6).map((review) => (
            <figure
              key={review.id}
              className="flex flex-col rounded-2xl border border-white/10 bg-white/5 p-7 backdrop-blur-sm transition-colors hover:border-gold-light/30"
            >
              <Quote className="size-7 text-gold-light/50" />
              ...
              <figcaption className="mt-6 flex items-center gap-3 border-t border-white/10 pt-5">
                <Avatar className="size-10">
                  <AvatarFallback className="bg-gold/20 text-xs font-semibold text-gold-light">
                ...
                <div className="min-w-0">
                  ...
                  <Link
                    ...
                    className="truncate text-xs text-white/55 transition-colors hover:text-gold-light"
                  >
                    {review.tourTitle}
                  </Link>
                </div>
