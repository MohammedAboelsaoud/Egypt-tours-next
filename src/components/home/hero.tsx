...
export function Hero() {
  return (
    <section className="relative isolate flex min-h-[92vh] items-center overflow-hidden">
      ...
      <div className="container-page w-full pt-28 pb-20">
        ...
        >
          ...
          <h1 className="mt-6 font-heading text-[2.75rem] leading-[1.05] text-white text-balance sm:text-6xl lg:text-7xl">
            Egypt, Planned
            <span className="block text-gold-light">Around You</span>
          </h1>
        ...
        >
          {STATS.map((stat) => (
            <div key={stat.label}>
              ...
              <dd>
                <span className="block font-heading text-2xl text-gold-light sm:text-3xl">
                  {stat.value}
                </span>
      ...
      <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-sand to-transparent" />
    </section>
  )
}
