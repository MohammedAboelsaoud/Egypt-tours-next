  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span className="absolute top-4 left-4 rounded-full bg-papyrus/95 px-3 py-1 text-[0.65rem] font-semibold tracking-[0.12em] text-basalt uppercase">
          {car.type}
        </span>
        {!car.available && (
          <span className="absolute top-4 right-4 rounded-full bg-basalt/85 px-3 py-1 text-[0.65rem] font-semibold tracking-[0.12em] text-white uppercase">
            Unavailable
          </span>
        )}
      </Link>
      ...
      <div className="flex flex-1 flex-col p-6">
        <span className="flex items-center gap-1.5 text-xs text-muted-foreground">
          <MapPin className="size-3.5 text-lapis" />
          {car.region.name}
        </span>
        ...
        <dl className="mt-5 grid grid-cols-3 gap-2 border-y border-border py-3 text-center text-xs">
          <div>
            ...
            <dd className="flex flex-col items-center gap-1 text-muted-foreground">
              <Users className="size-4 text-lapis" />
              {car.seats} seats
            </dd>
          </div>
          <div>
            ...
            <dd className="flex flex-col items-center gap-1 text-muted-foreground">
              <Settings2 className="size-4 text-lapis" />
              {car.transmission}
            </dd>
          </div>
          <div>
            ...
            <dd className="flex flex-col items-center gap-1 text-muted-foreground">
              <Fuel className="size-4 text-lapis" />
              {car.fuelType}
            </dd>
          </div>
        </dl>
